import PropertyIdentity from "./sections/property-identity";
import PropertyLocation from "./sections/property-location";
import PropertyConfiguration from "./sections/property-configuration";
import PropertyOperations from "./sections/property-operations";
import PropertyBank from "./sections/property-bank";
import PropertyCorporate from "./sections/property-corporate";
import PropertyTax from "./sections/property-tax";
