...
export default function PaymentsEmbedded({
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-[5px] border border-border/40 bg-background overflow-hidden shadow-sm">
                        ...
                        return (
                            <DataGridRow key={p.id || index} className="hover:bg-muted/5 transition-colors">
                                    ...
                                    {isExisting ? (
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                type="number"
                                                placeholder="0.00"
                                                className="h-9 pl-6 text-sm bg-background border-border/40 focus-visible:ring-primary/20 font-semibold"
                                                value={p.paid_amount}
                                ...
                                <DataGridCell>
                                    {isExisting ? (
                                        <div className="space-y-1">
                                            {p.comments && <p className="text-xs text-foreground/80 italic">"{p.comments}"</p>}
                                            {p.transaction_id && (
                                        ...
                                        <div className="space-y-2 py-1">
                                            <Input
                                                ...
                                                className="h-8 text-[11px] bg-background border-border/20 italic"
                                                value={p.comments}
                                ...
                                <DataGridCell className="text-center">
                                    {!isExisting && payments.filter(x => !x.id).length > 1 && (
                                        <Button
                                            variant="ghost"
                                            size="sm"
