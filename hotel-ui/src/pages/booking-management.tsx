...
const ChangeRoomModal = lazy(() => import("@/components/booking/change-room-modal"));
...
import { logout } from "@/redux/slices/is-logged-in-slice";
import { normalizeNumberInput } from "@/utils/normalize-text-input";
import { useNavigate, useLocation } from "react-router-dom";
import { formatToDDMMYY } from "@/utils/format-to-ddmmyy";
const GuestsEmbedded = lazy(() => import("@/components/layout/guests-embedded"));
const VehiclesEmbedded = lazy(() => import("@/components/layout/vehicles-embedded"));
const PaymentsEmbedded = lazy(() => import("@/components/layout/payment-embedded"));
const LaundryEmbedded = lazy(() => import("@/components/layout/laundry-embedded"));
const BookingLogsEmbedded = lazy(() => import("@/components/layout/booking-logs-embedded"));
const RestaurantOrdersEmbedded = lazy(() => import("@/components/layout/restaurant-orders-embedded"));
...
import { formatAppDate, parseAppDate, toISODateOnly, formatAppDateTime } from "@/utils/date-format";
...
export default function BookingsManagement() {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            const { default: BookingSummaryPDF } = await import("@/components/pdf/booking-summary-pdf");
