...
import PropertyIdentity from "@/components/property-form/sections/property-identity";
import PropertyLocation from "@/components/property-form/sections/property-location";
import PropertyTax from "@/components/property-form/sections/property-tax";
import PropertyConfiguration from "@/components/property-form/sections/property-configuration";
import PropertyOperations from "@/components/property-form/sections/property-operations";
import PropertyBank from "@/components/property-form/sections/property-bank";
import PropertyCorporate from "@/components/property-form/sections/property-corporate";
...
export default function PropertyManagement() {
    ...
    function normalizeForCompare(payload: any) {
        ...
        delete clone.image;
        delete clone.floors;
        delete clone.phone_country_code;
        delete clone.phone_office_country_code;
