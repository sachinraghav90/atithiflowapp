...
import { formatAppDateTime, toDatetimeLocalValue } from "@/utils/date-format";
                                    ...
                                    {/* METHOD */}
                                            <DataGridCell className="border-r border-slate-200/40">
                                                {isEditable ? (
                                                    ...
                                                    <span className="text-xs font-semibold tracking-wide text-muted-foreground bg-muted/30 px-2 py-0.5 rounded">
                                                        {p.payment_method}
                                                    </span>
                                                )}
                                            </DataGridCell>
